...
class Tests {
    ...
    @Tag("Impossible")
    fun russian() {
        assertEquals("двести тридцать три тысячи семь", russian(233007))
        assertEquals("триста четырнадцать тысяч восемьсот шестьдесят три", russian(314863))
        ...
        assertEquals("девятьсот десять тысяч двадцать", russian(910020))
